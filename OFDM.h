...
// bits per symbol for supported modulations
#define BPSK 1
#define QPSK 2
#define QAM16 4
#define QAM64 6
...
double q_inv(double x);

// Tx side

double get_snr_threshold(int bitsPerSymbol, double ber_target);
double get_snr_threshold_alt(int bitsPerSymbol, double ber_target);
